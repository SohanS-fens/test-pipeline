...
declare -a modules=("iam_user_all_rules_violation" "account_rules_violation" "cloudtrail_and_s3_bucket_rules_violation" "kms_key_rules_violation" "network_acl_rules_violation" "security_group_rules_violation" "RDS_rules_violation" "EC2_rules_violation")
